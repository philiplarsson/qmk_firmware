...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_TAB,         SE_AA,        SE_AE,   SE_OSLH, KC_P,   KC_Y,   MEH(KC_NO),
        KC_LCTL,        KC_A,           KC_O,    KC_E,    KC_U,   KC_I,
        KC_LSFT,        KC_DOT,         KC_Q,    KC_J,    KC_K,   KC_X,   ALL_T(KC_NO),
        SE_LESS_MAC,    SE_LESS,          KC_NO, MO(2),   LGUI(KC_SPC),
        ...
        ALL_T(KC_NO),   KC_B,   KC_M,      KC_W,   KC_V,         KC_Z,           KC_RSFT,
	                   LT(2,KC_ESC), SE_APOS,       SE_ACUT,      KC_NO,     KC_NO,
             KC_PGUP, KC_RALT,
             KC_PGDN,
             MO(2), MO(1), KC_ENT
    ),
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,LSFT(SE_PLUS), SE_LCBR, SE_RCBR, SE_AT, SE_CIRC, KC_TRNS,
       KC_TRNS,SE_APOS,   SE_LPRN, SE_RPRN,SE_DLR, SE_PIPE,
       KC_TRNS,LSFT(SE_ACUT),      SE_LBRC, SE_RBRC,LSFT(KC_6),SE_TILD,SE_PLUS,
       ...
       KC_TRNS, KC_NO,   KC_NO,   LSFT(KC_0),    SE_GRTR,    KC_NO, KC_F12,
       LSFT(KC_7),  SE_LESS,  KC_SLSH, SE_GRTR, KC_NO,  KC_NO,
...
[ARROW] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_NO, KC_7,   KC_8,    KC_9,    LSFT(SE_APOS), SE_PLUS,
